...
aptos_agent = Agent(
    ...
    instructions=(
        ...
        "If you ever need test funds, you can request them from the Aptos Testnet Faucet, but remember to specify an amount. "
        ...
        "'https://explorer.aptoslabs.com/txn/(transaction hash)/payload?network=devnet', where they can see it on the explorer for themselves "
